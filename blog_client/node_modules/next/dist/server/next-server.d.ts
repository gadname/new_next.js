...
import 'next/dist/lib/polyfill-promise-with-resolvers';
...
import type { Options, FindComponentsResult, MiddlewareRoutingItem, RequestContext, NormalizedRouteManifest, LoadedRenderOpts } from 'next/dist/server/base-server';
